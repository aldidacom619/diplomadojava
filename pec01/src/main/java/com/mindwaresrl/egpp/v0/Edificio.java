...
public class Edificio extends Entidad {
	...
	public void generarResumen() throws Exception {
		PrintWriter fichero = new PrintWriter(new FileWriter("resumen.txt"));
	...
	public void generarPropiedades() throws Exception {
		PrintWriter fichero = new PrintWriter(new FileWriter("propiedades.txt"));
	...
	public void generarPropietarios() throws Exception{
		PrintWriter fichero = new PrintWriter(new FileWriter("propietarios.txt"));
	...
	public void generarCuotas() throws Exception{
		PrintWriter fichero = new PrintWriter(new FileWriter("cuotas.txt"));
